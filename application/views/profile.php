...
<?php 
    ...
    $picHtml="<div class=\"block check2\" style=\"background: url(http://www.newgiftideas.org/wp-content/uploads/2012/08/gifts.jpg) no-repeat center; background-size: cover;\"></div>";
